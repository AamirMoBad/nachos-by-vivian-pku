...
public class KThread {
	...
	//implemented by d.liu
	if(this.status == KThread.statusFinished){ // this thread is already finished, return immediately
		return;
	}
    ...
    // mark this thread if the join() method has been called once
    private boolean isJoined = false;
    
    // the other thread that called join() method
